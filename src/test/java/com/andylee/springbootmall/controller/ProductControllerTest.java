...
public class ProductControllerTest {
    ...
    public void createProduct_success() throws Exception {
        ...
        productRequest.setDescription("test nice !!");
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.description", equalTo("test nice !!")))
                .andExpect(jsonPath("$.createdDate", notNullValue()))
                .andExpect(jsonPath("$.lastModifiedDate", notNullValue()));
    }
    ...
    public void updateProduct_success() throws Exception {
        ...
        productRequest.setPrice(100);
        productRequest.setStock(2);
        productRequest.setDescription("test good");
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.price", equalTo(100)))
                .andExpect(jsonPath("$.stock", equalTo(2)))
                .andExpect(jsonPath("$.description", equalTo("test good")))
                .andExpect(jsonPath("$.createdDate", notNullValue()))
                .andExpect(jsonPath("$.lastModifiedDate", notNullValue()));
    }
